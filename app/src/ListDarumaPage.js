  ...
  return (
    <Box sx={{ margin: "10px 10px", width: "100%", overflow: "hidden" }}>
      ...
      <Box
        ...
        <DarumaCard typeOfDaruma='chance' />
        <DarumaCard typeOfDaruma='protection' />
        <DarumaCard typeOfDaruma='love' />
        <DarumaCard typeOfDaruma='goal' />
        <DarumaCard typeOfDaruma='abundance' />
      </Box>
    </Box>
  );
}
